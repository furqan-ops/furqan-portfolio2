...
export const projects = [
  {
    name: "attendance-app",
    tags: ["Google Apps Script", "JavaScript", "Sheets"],
    desc: "Full attendance system built in Google Apps Script with vanilla JavaScript. Separate admin and employee views - check-in / check-out, leave requests, and monthly summaries, all running inside Google Workspace.",
  },
  {
    name: "rfp-lead-generator",
    tags: ["Python", "Gemini", "Sheets", "Gmail"],
    desc: "Scheduled Python automation that polls an RFP feed, generates an AI summary of each listing with Gemini, logs new leads to Google Sheets, and emails a formatted HTML alert - with deduplication against existing entries.",
  },
  {
